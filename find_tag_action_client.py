...
# from robot_actions.action import Tag
...
# 
#     # 2) (Optional) set initial pose if using localization
#     # initial_pose = PoseStamped()
#     # … fill in initial_pose …
#     # navigator.setInitialPose(initial_pose)
# 
#     # 3) Wait for all Nav2 lifecycle nodes to reach ACTIVE
#     navigator.waitUntilNav2Active()
# 
#     # 4) Send our navigation goal
...
# 
#     # 5) Spin both nodes concurrently
...
def main(args=None):
    ...
    try:
        navigator.waitUntilNav2Active()  # CHANGE
        navigator.goToPose(goal_pose)
